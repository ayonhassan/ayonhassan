# Decompile by Hassan (Tools By Hassan)
...
logo =                                          ("""   
\x1b[1;90m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┑
\x1b[1;90m┃            \033[1;91m_   _   _   _   _   _   \x1b[1;90m          ┃
\x1b[1;90m┃           \033[1;32m/ \ / \ / \ / \ / \ / \   \x1b[1;90m         ┃
\x1b[1;90m┃        \033[1;92m  ( H | A | S | S | A | N )  \x1b[1;90m         ┃
\x1b[1;90m┃        \033[1;33m   \_/ \_/ \_/ \_/ \_/ \_/  \x1b[1;90m          ┃
\x1b[1;90m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: Hassan
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94mAyonhassan
\x1b[1;36m{+} \x1b[1;93mTOOL / \x1b[1;92mNAME      \x1b[1;97m : \x1b[1;93mSms \x1b[1;92mBombing
\033[1;96m═════════════════════════════════════════════
""")
...
print (logo)
print(w+"[~] CHECKING APPROVAL PLEASE WAIT...")
os.system('clear')
print(logo)
print(w+"[~] CHECKING APPROVAL PLEASE WAIT...")
os.system("xdg-open https://www.facebook.com/profile.php?id=100069791474491")
import getpass
...
while attemps < 12345677901:
    ...
    if username == 'ayon' and password == 'hassan':
        print('LOGIN SUCCESFULLY')
        break
    else:
        print('          \033[1;32m𝙄𝙉𝙑𝘼𝙇𝙄𝘿 𝙐𝙎𝙀𝙍 & 𝙋𝘼𝙎𝙎' )
        print('          \033[1;32m𝘾𝙤𝙣𝙩𝙖𝙘𝙩 𝙒𝙞𝙩𝙝 𝘼𝙙𝙢𝙞𝙣 𝙁𝙤𝙧 𝙐𝙨𝙚𝙧-𝙋𝙖𝙨𝙨' )
        os.system("xdg-open https://www.facebook.com/profile.php?id=100069791474491")
        attemps += 1
        continue
os.system('clear')
...
os.system('clear')
print(logo)
print(w+"[~] Conneting with internet...")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g} DON'T JUDGE A BOOK BY IT'S COVER {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY  "+w+tim)
	...
	os.system("clear")
	os.system("python SMS-BOMBER.py")
